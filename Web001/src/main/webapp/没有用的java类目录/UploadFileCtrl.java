...
public class UploadFileCtrl {
	...
	private  GetAllZhiLiaoService getAllZhiKLiaoService;
	
	public void setGetAllZhiKLiaoService(GetAllZhiLiaoService getAllZhiKLiaoService) {
	...
	public ModelAndView upload(@RequestParam(value = "file", required = false) MultipartFile file,
		...
		try {
			...
			resultList=getAllZhiKLiaoService.excuteGetAllZhiLiaoService(paramMap);
			//修改state
